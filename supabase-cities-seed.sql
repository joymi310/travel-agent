insert into cities (slug, name, country, region, hero_tagline, overview, neighbourhoods, best_time, getting_around, visa_notes, suggested_questions, is_published, reviewed) values (
  ...
  $$[{"name":"Shinjuku","vibe":"Neon-lit and relentless — the entertainment capital of Tokyo with world-class nightlife.","best_for":"Nightlife, first-timers, shopping","price_range":"Mid-range"},{"name":"Shibuya","vibe":"Youth culture, iconic fashion and the world's busiest pedestrian crossing.","best_for":"Young travellers, shopping","price_range":"Mid-range"},{"name":"Asakusa","vibe":"Old Tokyo — rickshaws, Senso-ji Temple and traditional craft shops.","best_for":"Culture seekers, families","price_range":"Budget"},{"name":"Shimokitazawa","vibe":"Tokyo's indie neighbourhood — vintage shops, jazz bars and tiny live music venues.","best_for":"Couples, creative travellers","price_range":"Budget"}]$$::jsonb,
...
insert into cities (slug, name, country, region, hero_tagline, overview, neighbourhoods, best_time, getting_around, visa_notes, suggested_questions, is_published, reviewed) values (
  ...
  $$[{"name":"Sukhumvit","vibe":"Bangkok's international strip — expat bars, malls and some of the city's best restaurants.","best_for":"Expats, nightlife, foodies","price_range":"Mid-range"},{"name":"Silom & Sathorn","vibe":"Business district by day, legendary rooftop bars and nightlife by night.","best_for":"Couples, nightlife seekers","price_range":"Mid-range"},{"name":"Rattanakosin","vibe":"The historic heart — temples, the Grand Palace and budget guesthouses on the river.","best_for":"Families, culture seekers, budget travellers","price_range":"Budget"},{"name":"Ari","vibe":"A leafy, local neighbourhood beloved by Bangkok's young creative class.","best_for":"Slow travellers, couples","price_range":"Mid-range"}]$$::jsonb,
...
insert into cities (slug, name, country, region, hero_tagline, overview, neighbourhoods, best_time, getting_around, visa_notes, suggested_questions, is_published, reviewed) values (
  ...
  $$[{"name":"The Bund","vibe":"Shanghai's iconic waterfront — colonial architecture facing the futuristic Pudong skyline.","best_for":"First-timers, photography, luxury","price_range":"Luxury"},{"name":"French Concession","vibe":"Tree-lined streets packed with boutiques, cafes and Shanghai's best restaurants and bars.","best_for":"Foodies, couples, design lovers","price_range":"Mid-range"},{"name":"Pudong","vibe":"Futuristic Manhattan-on-steroids with the Oriental Pearl Tower and world-class hotels.","best_for":"Business travellers, families","price_range":"Luxury"},{"name":"Jing'an","vibe":"Upscale shopping, cultural venues and excellent international dining.","best_for":"Shoppers, expats","price_range":"Mid-range"}]$$::jsonb,
...
insert into cities (slug, name, country, region, hero_tagline, overview, neighbourhoods, best_time, getting_around, visa_notes, suggested_questions, is_published, reviewed) values (
  ...
  $$[{"name":"Seminyak","vibe":"Bali's upscale beach hub — beach clubs, designer boutiques and excellent restaurants.","best_for":"Couples, beach lovers, foodies","price_range":"Mid-range"},{"name":"Canggu","vibe":"The digital nomad capital of Asia — surf breaks, rice paddies and excellent coffee.","best_for":"Surfers, nomads, young travellers","price_range":"Mid-range"},{"name":"Ubud","vibe":"Bali's cultural heart — rice terraces, temple ceremonies and a thriving wellness scene.","best_for":"Culture seekers, families, wellness travellers","price_range":"Budget"},{"name":"Nusa Dua","vibe":"A gated resort enclave with calm turquoise beaches and international luxury hotels.","best_for":"Families, luxury travellers","price_range":"Luxury"}]$$::jsonb,
...
insert into cities (slug, name, country, region, hero_tagline, overview, neighbourhoods, best_time, getting_around, visa_notes, suggested_questions, is_published, reviewed) values (
  ...
  $$[{"name":"Medina","vibe":"The historic walled city — ancient, labyrinthine and extraordinary. Stay here for the full Marrakech experience.","best_for":"First-timers, culture lovers, couples","price_range":"Mid-range"},{"name":"Gueliz","vibe":"Marrakech's modern neighbourhood — wide boulevards, rooftop restaurants and easy navigation.","best_for":"Families, those who prefer calm","price_range":"Mid-range"},{"name":"Mellah","vibe":"The ancient Jewish quarter with spice-scented alleyways and hidden neighbourhood gems.","best_for":"History buffs, photographers","price_range":"Budget"},{"name":"Palmeraie","vibe":"A palm grove resort district outside the city walls — exclusive and tranquil.","best_for":"Luxury travellers","price_range":"Luxury"}]$$::jsonb,
